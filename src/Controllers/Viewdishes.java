 ...
 */
@WebServlet("/Viewdishes")
public class Viewdishes extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //  session.setAttribute("li", lfi);	
        int recordsPerPage;
 		...
 		List<FoodItems> dblist = ds.getPageRecords(currentPage, recordsPerPage);
 		request.setAttribute("dishrecords", dblist);
 		for(FoodItems i:dblist){
        ...
        RequestDispatcher view=request.getRequestDispatcher("WEB-INF/views/Viewdishes.jsp");

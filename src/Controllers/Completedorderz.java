...
/**
 * Servlet implementation class Completedorderz
 */
@WebServlet("/Completedorderz")
public class Completedorderz extends HttpServlet {
    ...
    List<Orderz> getPageRecords(int currentPage, int recordsPerPage, List<Orderz> par) {
		...
		for (Orderz pari : par) {
		//	System.out.println(pari.getOrdered_dish()+"------- not assigned inner");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 ...
		 List<Orderz> listch=os.getOrder();
		   ...
		   // request.getSession().setAttribute("chef_list", listch);
			...
			request.setAttribute("comptorderrecords", dblist);
			for(Orderz i:dblist){
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/views/Completedorderz.jsp");

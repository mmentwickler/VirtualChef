...
<center>
		...
		<div class="content-page">
			...
			<div class="content">
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title float-left">Messages</h4>
				...
				<tbody>
					...
					<c:forEach items="${adminorderrecords}" var="record">
                         	 <form  method="POST" action="OrderDelivery">
				
					      <input type="hidden" name="adminorder_id" value="${record.getId()}">
                      	...
                      	<tr>
							...
							<td> <select name="dstatus" onchange="this.form.submit()">
									<option value="start"></option>
								   <option value="dBoyontheway">Delivery Boy On The Way</option>
	...
	<ul class="pagination">
					<c:if test="${currentPage != 1}">
						<li class="page-item"><a class="page-link"
							href="Adminnotifypagi?recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">Previous</a>
						</li>
					</c:if>
					...
					<c:forEach begin="1" end="${noOfPages}" var="i">
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a class="page-link"
									href="Adminnotifypagi?recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
								</li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					<c:if test="${currentPage lt noOfPages}">
						<li class="page-item"><a class="page-link"
							href="Adminnotifypagi?recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}">Next</a>
						</li>
					</c:if>
	...
	<!-- Chart JS -->
	<script src="ajs/chart.bundle.js"></script>

	<!-- init dashboard -->
	<script src="ajs/jquery.dashboard.init.js"></script>

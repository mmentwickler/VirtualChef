                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Add Dish</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Virtual Chef</a></li>
                                        <li class="breadcrumb-item"><a href="#">Dishes</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title" style="font-size:25px;">Add New Dish</h4>
                                   

                                    <form onsubmit="return validate_img()" method="post" action="Addnewdish" enctype="multipart/form-data" >
								
                                       
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Dish Name</label>
                                            <input name="name" type="text" class="form-control" id="inputAddress" placeholder="dish name ">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2" class="col-form-label">Price</label>
                                            <input name="price" type="text" class="form-control" id="inputAddress2" placeholder="00.00">
                                        </div>
					...
					<div class="form-group">
                                        	...
                                        	<option value="1">None</option>
                                        	                                        	...
                                        	                                        	<option value="5">Too much</option>
						...
						<div class="form-group">
						<label class="radio-inline"><div class="ttr_radio"><input type="radio" name="veg" id="radio11"  value="1"><label for="radio11"></label></div>Veg</label>
						<label class="radio-inline"><div class="ttr_radio"><input type="radio" name="veg" id="radio11"  value="0"><label for="radio11"></label></div>Non-Veg</label>
                                        ...
                                        <c:if test="${sessionScope.errordish != null}">
						                       <c:out value="${sessionScope.errordish}" />

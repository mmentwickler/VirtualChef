                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Delete Delivery Boy</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Virtual Chef</a></li>
                                        <li class="breadcrumb-item"><a href="#">Delivery Boy</a></li>
                                        <li class="breadcrumb-item active">Delete Delivery Boy</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title" style="font-size:25px;">Delete Delivery Boy</h4>
                                   

                                    <form method="post" action="Deldboy" >
									     <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Delivery Boy Id</label>
                                            <input name="id" type="number" class="form-control" id="inputAddress" placeholder=" id ">
                                        </div>
                                       
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Delivery Boy Name</label>
                                            <input name="name" type="text" class="form-control" id="inputAddress" >
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2" class="col-form-label">Delivery Boy Cnic</label>
                                            <input name="cnic" type="number" class="form-control" id="inputAddress2" >
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary">Delete DBoy</button>
                                        <c:if test="${sessionScope.dboydelerror != null}">
						                       <c:out value="${sessionScope.dboydelerror}" />

                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title" style="font-size:25px;">Delete Dish</h4>
                                   

                                    <form method="post" action="Deldish" >
									     <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Dish Id</label>
                                            <input name="id" type="number" class="form-control" id="inputAddress" placeholder="dish id ">
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary">Delete Dish</button>
                                          <c:if test="${sessionScope.errordeldish != null}">
						                       <c:out value="${sessionScope.errordeldish}" />

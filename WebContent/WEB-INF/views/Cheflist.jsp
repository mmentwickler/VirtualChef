					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title float-left">view</h4>

								<ol class="breadcrumb float-right">
									<li class="breadcrumb-item"><a href="#">Virtual Chef</a></li>
									<li class="breadcrumb-item"><a href="#">Chef</a></li>
							...
							<div class="card-box table-responsive">
								...
								<br> <br>
									...
									<table class="table table-striped table-bordered table-sm">
										...
										<c:forEach items="${chefrecords}" var="record">
											<tr>
												<td>${record.email}</td>
												<td>${record.getFirstName()}</td>
												<td>${record.getLastName()}</td>
												<td>${record.getEducation()}</td>
												<td>${record.getDob()}</td>
												<td>${record.getCnic()}</td>
												<td>${record.getPhone_number()}</td>
								...
								<ul class="pagination">
									<c:if test="${currentPage != 1}">
										<li class="page-item"><a class="page-link"
											href="ChefList?recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">Previous</a>
										</li>
									</c:if>
									...
									<c:forEach begin="1" end="${noOfPages}" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item"><a class="page-link"
													href="ChefList?recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
												</li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${currentPage lt noOfPages}">
										<li class="page-item"><a class="page-link"
											href="ChefList?recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}">Next</a>
										</li>
									</c:if>
								</ul>
								</nav>

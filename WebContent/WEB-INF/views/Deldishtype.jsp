                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <form method="post" action="Deldishtype" >
									     <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Dish Type Id</label>
                                        ...
                                        <button type="submit" class="btn btn-primary">Delete Dish</button>
                                          <c:if test="${sessionScope.errordeldishtype != null}">
						                       <c:out value="${sessionScope.errordeldishtype}" />

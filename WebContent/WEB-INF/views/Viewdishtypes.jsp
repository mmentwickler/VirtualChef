...
<center>
						...
						<li><a href="javascript: void(0);"><i class="fi-disc"></i><span>
							...
							<ul class="nav-second-level" aria-expanded="false">
								...
								<li>
									...
									<li>
									<form name="addDishType" method="get" action="Addnewdishtype">

										<a href="javascript:document.addDishType.submit()">Add Dish Type</a>
									</form>
								</li>
									<li>
									<form name="delDishType" method="get" action="Deldishtype">

										<a href="javascript:document.delDishType.submit()">Delete Dish Type</a>
									</form>
								</li>
		...
		<div class="content-page">
						...
						<div class="col-12">
							<div class="card-box table-responsive">
								...
								<table class="table table-striped table-bordered table-sm">
									...
									<c:forEach var="row" items="${dishtyperecords}">
										<tr>
											<td>${row.typeName}</td>
											<td><img
												src="${pageContext.servletContext.contextPath }/photoServletdt?id=${row.id}"
								...
								<ul class="pagination">
									<c:if test="${currentPage != 1}">
										<li class="page-item"><a class="page-link"
											href="Viewdishtypes?recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">Previous</a>
										</li>
									</c:if>
									...
									<c:forEach begin="1" end="${noOfPages}" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item"><a class="page-link"
													href="Viewdishtypes?recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
												</li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${currentPage lt noOfPages}">
										<li class="page-item"><a class="page-link"
											href="Viewdishtypes?recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}">Next</a>
										</li>
									</c:if>
								</ul>
								</nav>
			...
			<footer class="footer text-right"> 2017 - 2018 © Virtual
			Chef. - HighOnTech.com </footer>

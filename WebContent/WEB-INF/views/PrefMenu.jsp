...
<br><br><br><br>
	<span style="  font-family:'Roboto Slab','Arial';font-weight:700;font-size:2.571em;color:rgba(53,181,235,1);">Your DISHES</span></p>
<br>
<br><br>
</div>

<div class="container">
                                      <form method="post" action="UserPred" >
	<div class="row">
        <div class="col-md-6">
    		  <div id="custom-search-input" style="padding-left: 50px">
...
<p style="margin:0.71em 0em 0.36em 0em;line-height:1.69014084507042;">
<span style="font-family:'Roboto','Arial';font-weight:500;font-size:1.429em;color:rgba(34,34,34,1);">
How well we predict ?</span></p>
<br>

<label class="radio-inline"><div class="ttr_radio">
<input type="radio" name="pred" id="pred1" value="1"><label for="pred1"></label></div>Very bad</label>
<label class="radio-inline"><div class="ttr_radio" >
<input type="radio" name="pred" id="pred2"value="2"><label for="pred2"></label></div>Bad</label>
<label class="radio-inline"><div class="ttr_radio">
<input type="radio" name="pred" id="pred3" value="3"><label for="pred3"></label></div>Somehow Correct</label>
<label class="radio-inline"><div class="ttr_radio">
<input type="radio" name="pred" id="pred4" value="4"><label for="pred4"></label></div>Correct </label>
<label class="radio-inline"><div class="ttr_radio">
<input type="radio" name="pred" id="pred5" value="5"><label for="pred5"></label></div>Perfect</label>
   ...
   <button style="margin-right: 50px" class="buttonbb button2"  id="bx">Submit</button>
...
<div class="clearfix visible-lg-block visible-sm-block visible-md-block visible-xs-block">
 ...
 <c:forEach var="row" items="${sessionScope.foodItems}">

...
<!-- App favicon -->
<link rel="icon" type="image/ico" href="aimages/logo.JPG">
					...
					<div class="row">
						<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
							<div class="card-box tilebox-one">
								...
								<h4 class="mb-3" data-plugin="counterup">${sessionScope.totalorder}</h4>
								<span class="badge badge-primary">  </span> <span
									class="text-muted ml-2 vertical-middle"></span>
							</div>
						</div>
						...
						<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
							<div class="card-box tilebox-one">
								...
								<h4 class="mb-3">
									PKR-<span data-plugin="counterup">${sessionScope.rev}</span>
								</h4>
								<span class="badge badge-primary">  </span> <span
									class="text-muted ml-2 vertical-middle"></span>
							</div>

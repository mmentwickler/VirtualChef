					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title float-left">Active Orders</h4>
						...
						<div class="col-12">
							<div class="card-box table-responsive">
								...
								<br>
										...
										<c:forEach items="${actvorderrecords}" var="record">
											<tr>
												<td>${record.getOrdered_dish()}</td>
												<td>${record.getServings()}</td>
												<td>${record.getTotal_price()}</td>
												<td>${record.getStatus()}</td>
												<td>${record.getChef_order().getFirstName()}</td>
												<td>${record.getAddress()}</td>
												<td>
												<c:if test="${record.getStatus()=='dispatched'}">
													...
													<select name="dstatus" onchange="this.form.submit()">
								...
								<ul class="pagination">
									<c:if test="${currentPage != 1}">
										<li class="page-item"><a class="page-link"
											href="Activeorderz?recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">Previous</a>
										</li>
									</c:if>
									...
									<c:forEach begin="1" end="${noOfPages}" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item"><a class="page-link"
													href="Activeorderz?recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
												</li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${currentPage lt noOfPages}">
										<li class="page-item"><a class="page-link"
											href="Activeorderz?recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}">Next</a>
										</li>
									</c:if>
								</ul>
								</nav>

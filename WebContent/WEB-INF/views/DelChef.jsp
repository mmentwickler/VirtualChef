			...
			<div class="content">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title float-left">Delete</h4>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card-box">
								<h4 class="m-t-0 header-title" style="font-size: 25px;">Delete
									Chef</h4>


								<form method="post" action="DelChef" >
									...
									<div class="form-group">
										...
										<input name="cnic"  type="text" class="form-control" id="inputAddress2"
											placeholder="13101-3214555-7">
									</div>
								
								
									<button type="submit" class="btn btn-primary">Delete</button>
									<c:if test="${sessionScope.chefnotexist != null}">
						                       <c:out value="${sessionScope.chefnotexist}" />

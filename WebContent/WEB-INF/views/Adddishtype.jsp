                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <form onsubmit="return validate_img()" method="post" action="Addnewdishtype" enctype="multipart/form-data" >
								
                                       
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Dish Type Name</label>
                                            <input name="name" type="text" class="form-control" id="inputAddress" placeholder="dish type name ">
                                        </div>
                                   <!--      <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary">Add Dish Type</button>
                                        <c:if test="${sessionScope.errordishtype != null}">
						                       <c:out value="${sessionScope.errordishtype}" />
